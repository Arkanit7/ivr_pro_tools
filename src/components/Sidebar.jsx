...
function Sidebar() {
  ...
  return (
    <>
      <div
        className={cn(
          'scrollbar-thin sticky top-0 z-51 flex h-screen shrink-0 flex-col gap-4 overflow-x-hidden overflow-y-auto border-r border-border bg-background p-3 transition-[width] duration-300 ease-in-out',
          collapsed ? 'w-16' : 'w-64',
        )}
      >
