      ...
      <div className={cn(
        ...
        <div className={cn('flex items-center transition-all duration-300', collapsed ? 'justify-center gap-0' : 'gap-1')}>
          <Link
            ...
            className={cn(
              'overflow-hidden whitespace-nowrap pl-2 text-lg font-semibold text-foreground transition-all duration-300',
              collapsed ? 'w-0 max-w-0 pl-0 opacity-0 pointer-events-none' : 'flex-1 max-w-50 opacity-100',
            )}
          >
            IVR Pro Tools{' '}
          ...
          <button
            ...
            className={cn(buttonVariants({variant: 'ghost'}), 'h-8 w-8 shrink-0 p-0')}
